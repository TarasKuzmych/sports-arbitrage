...
def scrape_marca():
    ...
    # Perform the HTTP request with the cookies
    ...
    if response.status_code == 200:
        ...
        for link in links[:n]:
            # Wait for a random time between 1.57 and 7.23 seconds
            time.sleep(random.uniform(1.57, 7.23))
        ...
        # Save the combined HTML of the first n links to a single file
